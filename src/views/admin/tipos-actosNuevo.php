...
<html lang="en">
    ...
    <head>
        <title>Creación de tipo de acto</title>
    ...
    <body>
        ...
        <div class="container px-3 py-5">
            <h1 class="pb-2 border-bottom" style="text-align: left;">Nuevo tipo de acto</h1>
            <div class="container" style="justify-content: center; align-items: center; width: 600px;">
                ...
                <div class="formulario-datos" style="width: 576px;">
                    <?php require_once $_SERVER['DOCUMENT_ROOT'] . '/views/partials/tipos-actosForm.php' ?>
                </div>
            </div>
        </div>
    </body>
